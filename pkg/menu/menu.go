...
func (m *Menu) Display() ([]*Item, error) {
	...
	for {
		...
		switch keyCode {
		case enter:
			m.MenuItems[m.CursorPosition].Selected = !m.MenuItems[m.CursorPosition].Selected
...
func (m *Menu) getSelectedItems() []*Item {
